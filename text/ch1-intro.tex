...
have direct consequences for society and ecosystems.% livelihood of the people and ecosystems in the regions.
...
\added{For this reason, several primary questions about the AMS remain open such as mechanisms and sources for interannual variability and teleconnections \citep{cai2020}, the effect of greenhouse forcing on the monsoon dynamics \citep{liebmann2011,pascale2019} and the role of soil-atmosphere interactions \citep{dominguez2008,malhi2009,adams2013}.}% to further understand their variability. 
...
In other words, GCMs are rarely evaluated in the AMS, so our understanding is deficient  in the knowledge of the relevant biases in current GCMs and, therefore, GCMs are less frequently used to address scientific questions related to the AMS. 
 ...
 The first results of this thesis begin \added{with Chapter \ref{ch:4-ams}} by evaluating a state-of-the-art climate model in the AMS region and comparing the model with several observational datasets. %This , with assessing the roles of biases in the large-scale circulation that affect regional monsoon rainfall biases.
