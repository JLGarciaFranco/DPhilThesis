...
\added{Over regional scales, the seasonal migration of the ITCZ follows closely the seasonal cycle of SSTs, which depends on the solar insolation and the coupling between SST gradients, cloud radiative heating and the low-level easterly flow \citep[see e.g.][]{richter2014equatorial,siongco2015,oueslati2015,harrop2016}.
...
\added{In short, a plethora of hypotheses exist for the causes of the seasonality of the MSD, however, a key aspect of the climate of the AMS is the effect of ENSO, which is described and discussed in the following section.}
...
\added{ENSO teleconnections work through various pathways or mechanisms which include extra-tropical routes such as changes to the position and strength of subtropical jets \citep{fereday2020}, to the Pacific and North American circulation patterns \citep{bayr2019} as well as impacts to the North Atlantic via the stratospheric polar vortex \citep{domeisen2019}.}
  
 \added{ENSO teleconnections impact the AMS regions through both tropical and extratropical pathways \citep{marengo2012,sulca2018,cai2020}. For example, Figure \ref{fig:enso} shows the impact of ENSO over other tropical regions outside of the Pacific through the Walker circulation, as upper-level wind anomalies induce anomalous vertical motions over West Africa \citep{ropelewski1986,ropelewski1987} or South America \citep{sulca2018}.  
 The extratropical pathway involves anomalous Rossby wave-trains caused by tropical convective heating that propagate from the equatorial Pacific to the extratropical Pacific and Atlantic affecting  both  northern and southern hemispheres \citep{hoskins1981steady,jimenez2018tropospheric,fereday2020}. These wave-driven anomalies cause differences in the regional sea-level pressure systems and the location of the storm track. }
 
 \added{  For example, ENSO induces changes to the Aleutian Low pressure system and similar SLP anomalies of opposite sign over the North American continent, in a teleconnection pattern that is more commonly referred to as the Pacific-North American (PNA) and which also influences the underlying SSTs \citep{deser2010sea,lin2015subseasonal,bayr2019,jimenezesteve2020}. A similar teleconnection is observed as wave trains travelling from the South Pacific to the South Atlantic, i.e., the Pacific-South American (PSA) pattern \citep{mo2001pacific,vera2009,cai2020}. Specifically, El Niño events induce a positive phase of the PNA pattern during boreal winter which leads to enhanced precipitation and colder conditions over northern Mexico due to the increased frequency of the intrusion of cold mid-latitude disturbances \citep{magana2003}. }
 ...
 \added{
  Current research on ENSO teleconnections to South America focuses on the observed non-linearity and asymmetry of the impacts, which has mainly been attributed to ENSO diversity \citep{tedeschi2015,cai2020,jimenez2021}.
...
\added{The suggestion that the QBO induces variability of the UTLS static stability is the leading hypothesis for the tropical route of QBO teleconnections \citep{giorgetta1999,liess2012,nie2015}. In short, this argument suggests the upper-level static stability, decreased under QBOE and increased under QBOW, can impact the strength of convection. }
...
Another relevant study by \cite{liess2012} found that satellite-derived cloud thickness and frequency  and upper-level velocity potential had a significant and longitudinally asymmetric response to the QBO. In particular, their results show increased convective activity during QBOE in the West Pacific but the opposite for the East Pacific. \added{ For this reason, \cite{liess2012} also argue that the strength of the Walker circulation may be modulated by the QBO, indicating the a possible indirect of the QBO, which could explain the observed impacts of opposite signs at equatorial latitudes.}
